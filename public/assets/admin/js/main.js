...
(function ($) {
	...
	// Prevent error if Smooth Scrollbar plugin is not loaded
	if (typeof Scrollbar !== "undefined" && typeof Scrollbar.init === "function") {
		$(".card-scrollbar").each(function (i, element) {
			Scrollbar.init(element, customizeOptions);
		});
	} else {
		console.warn("Smooth Scrollbar plugin is missing or not loaded before main.js");
	}
	/* Scrollbar js end */
