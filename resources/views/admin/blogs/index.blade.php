                ...
                <div class="row mb-3">
                    <div class="col-xl-12">
                        <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
                            <h1 class="fs-18 mb-0">{{ $title ?? 'Blogs Management' }}</h1>
                            ...
                            <div class="card border-0 shadow-sm">
                                <div class="card-body p-3 p-md-4">
                                    <div class="row g-3 align-items-end">
                                        ...
                                        <!-- Category Filter -->
                                        <div class="col-lg-2 col-md-6">
                                            <label for="filterCategory" class="form-label fw-semibold mb-2">
                        ...
                        <div class="col-12">
                            <div class="alert alert-warning border-0 shadow-sm" role="alert">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <strong>Access Restricted!</strong> You don't have permission to view blogs.
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        (function($) {
            ...
            const LOADING_OVERLAY = `
                <div class="loading-overlay position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center justify-content-center bg-white bg-opacity-75" style="z-index: 10; min-height: 300px;">
                    <div class="text-center">
                        ...
                        <p class="text-muted fw-semibold mb-0">Loading blogs...</p>
            ...
            function showLoadingOverlay() {
                ...
                $('#rangeCalendar, #filterStatus, #filterCategory').prop('disabled', true);
            ...
            function hideLoadingOverlay() {
                ...
                $('#rangeCalendar, #filterStatus, #filterCategory').prop('disabled', false);
                    ...
                    .DataTable({
                        ...
                        ajax: {
                            ...
                            error: function(xhr, error, thrown) {
                                ...
                                showAlert(
                                    '<strong>Error!</strong> Unable to load blogs. Please check your connection and try again.',
                                    'danger',
                                    'error-warning-line',
                                    6000
                                );
                        ...
                        drawCallback: function(settings) {
                            ...
                            if ((isInitialLoad || isFilterChange) && recordsTotal > 0) {
                                showAlert(
                                    `<strong>Success!</strong> Loaded ${recordsTotal} blog(s) successfully.`,
                                    'success',
            ...
            function bindFilterEvents() {
                ...
                $resetBtn.on('click', function() {
                    ...
                    setTimeout(function() {
                        ...
                        showAlert(
                            '<strong>Filters Reset!</strong> Showing all blogs.',
                            'info',
                            'information-line',
                            2500
                        );
                ...
                // Enter key to search
                $('#filterStatus, #filterCategory').on('keypress', function(e) {
                    if (e.which === 13) {
                        $searchBtn.click();
                    }
                });
            ...
            $(document).ready(function() {
                @can('blogs.view.any')
                    ...
                    setTimeout(function() {
                        if (isInitialLoad) {
                            showAlert(
                                '<strong>Welcome!</strong> Blog management system loaded successfully.',
                                'info',
                                'information-line',
                                3000
                            );
