                        ...
                        <div
                            ...
                            <div>
                                <div class="d-flex align-items-center gap-3 mb-2">
                                    <div>
                                        <h1 class="h2 fw-bold mb-1">Role Details</h1>
                                        <p class="text-muted mb-0">View role information and assigned permissions.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb bg-white shadow-sm border px-3 py-2 rounded-3">
                                    ...
                                    <li class="breadcrumb-item active text-primary fw-medium">View</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
