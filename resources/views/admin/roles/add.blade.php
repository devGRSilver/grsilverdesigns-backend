                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="d-flex align-items-center gap-3">
                                            ...
                                            <div>
                                                ...
                                                <small class="opacity-75">Select access permissions for this role</small>
                                            </div>
                                        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            function initializeCheckboxStates() {
                ...
                console.log('Selected permissions after init:', Array.from(selectedPermissions.keys()));
            ...
            function updateSelectedPermissionsList() {
                ...
                console.log('Updated selected count:', selectedPermissions.size);

                // Add remove functionality
                $('.remove-permission').on('click', function(e) {
                    e.stopPropagation(); // Prevent card click event
                    const permissionId = $(this).data('permission-id');
                    console.log('Removing permission via button:', permissionId);
            ...
            function updateGroupSelectionStates() {
                ...
                console.log('Group states updated. Total checked:', checkedAll, '/', totalPermissions);
            }
            ...
            permissionCheckboxes.on('change', function(e) {
                ...
                console.log(`Permission ${permissionId} (${permissionName}) changed to:`, isChecked);
