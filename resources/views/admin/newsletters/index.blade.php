                ...
                <div class="row mb-3">
                    <div class="col-xl-12">
                        <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
                            <h1 class="fs-18 mb-0">{{ $title ?? 'Newsletter Subscribers Management' }}</h1>
                                    ...
                                    <table id="dataTable" class="table table-bordered table-hover align-middle w-100">
                                        <thead class="table-light">
                                            <tr>
                                                ...
                                                <th class="px-3 py-3 fw-semibold">Subscribed At</th>
        ...
        (function($) {
            ...
            const LOADING_OVERLAY = `
                <div class="loading-overlay position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center justify-content-center bg-white bg-opacity-75" style="z-index: 10; min-height: 300px;">
                    <div class="text-center">
                        ...
                        <p class="text-muted fw-semibold mb-0">Loading newsletter subscribers...</p>
                    ...
                    .DataTable({
                        ...
                        ajax: {
                            ...
                            error: function(xhr, error, thrown) {
                                ...
                                showAlert(
                                    '<strong>Error!</strong> Unable to load newsletter subscribers. Please check your connection and try again.',
                                    'danger',
                                    'error-warning-line',
                                    6000
                                );
                        ...
                        columns: [{
                            ...
                            {
                                data: 'email',
                                className: 'px-3 py-2 email-cell fw-medium'
                            },
                            {
                                data: 'name',
                                className: 'px-3 py-2'
                        ...
                        language: {
                            ...
                            zeroRecords: `
                                <div class="text-center py-5 my-5">
                                    <i class="ri-mail-line display-1 text-muted mb-3 d-block"></i>
                            ...
                            infoEmpty: "No subscribers to display",
                        ...
                        drawCallback: function(settings) {
                            ...
                            if ((isInitialLoad || isFilterChange) && recordsTotal > 0) {
                                showAlert(
                                    `<strong>Success!</strong> Loaded ${recordsTotal} subscriber(s) successfully.`,
                                    'success',
            ...
            function bindFilterEvents() {
                ...
                $resetBtn.on('click', function() {
                    ...
                    setTimeout(function() {
                        ...
                        showAlert(
                            '<strong>Filters Reset!</strong> Showing all subscribers.',
                            'info',
                            'information-line',
                            2500
                        );
                ...
                @can('newsletters.export')
                    $('#exportBtn').on('click', function() {
                        ...
                        link.href = url;
                        link.download = 'subscribers_export_' + new Date().toISOString().split('T')[0] +
                            '.xlsx';
                        ...
                        setTimeout(() => {
                            $this.prop('disabled', false).html(
                                '<i class="ri-download-line me-1"></i> Export');
                            showAlert(
                                '<strong>Export Started!</strong> Your subscribers export has been initiated.',
                                'success',
                                'download-line',
                                3000
                            );
            ...
            function initNewsletterHandlers() {
                $(document).on('click', '.send-newsletter', function(e) {
                    ...
                    $.confirm({
                        ...
                        content: `
                            <div class="mb-3">
                                <label class="form-label">Send test newsletter to:</label>
                                <div class="p-2 bg-light rounded mb-2">
                                    <code>${subscriberEmail}</code>
                                </div>
                                <p class="text-muted small">This will send a test newsletter email to this subscriber.</p>
                            </div>
                        `,
                                ...
                                action: function() {
                                    $.ajax({
                                        ...
                                        success: function(response) {
                                            showAlert(
                                                `<strong>Success!</strong> Test newsletter sent to ${subscriberEmail}.`,
                                                'success',
                                                'checkbox-circle-line',
                                                4000
                                            );
                                        ...
                                        error: function(xhr) {
                                            showAlert(
                                                `<strong>Error!</strong> ${xhr.responseJSON?.message || 'Unable to send newsletter.'}`,
                                                'danger',
                                                'error-warning-line',
                                                5000
                                            );
            ...
            $(document).ready(function() {
                ...
                setTimeout(function() {
                    if (isInitialLoad) {
                        showAlert(
                            '<strong>Welcome!</strong> Newsletter subscribers management system loaded successfully.',
                            'info',
                            'information-line',
                            3000
                        );
