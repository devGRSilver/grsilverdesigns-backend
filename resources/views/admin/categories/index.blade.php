                                    ...
                                    <div class="col-lg-4 col-md-8">
                                        <div class="d-flex gap-2 flex-wrap">
                                            ...
                                            @can('categories.create')
                                                <button type="button" href="{{ route('categories.create') }}"
                    ...
                    <div class="col-12">
                        <div class="alert alert-info border-0 shadow-sm" role="alert">
                            <div class="d-flex align-items-start">
                                ...
                                <div>
                                    <h6 class="alert-heading fw-semibold mb-1">Categories Information</h6>
                                    <p class="mb-0">
                                        This page displays all categories. To view subcategories of a specific parent
                                        category,
                                        click on the subcategory count in the table or select the parent from the filter
                                        above.
                                    </p>
                                </div>
                            </div>
                                    ...
                                    <table id="dataTable" class="table table-bordered table-hover align-middle w-100">
                                        <thead class="table-light">
                                            <tr>
                                                ...
                                                <th class="px-3 py-3 fw-semibold">Icon</th>
                                                <th class="px-3 py-3 fw-semibold">Banner</th>
                                                ...
                                                <th class="px-3 py-3 fw-semibold text-center">Subcategories</th>
    ...
    <script>
        (function($) {
            ...
            const LOADING_OVERLAY = `
                <div class="loading-overlay position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center justify-content-center bg-white bg-opacity-75" style="z-index: 10; min-height: 300px;">
                    <div class="text-center">
                        ...
                        <p class="text-muted fw-semibold mb-0">Loading categories...</p>
            ...
            function showLoadingOverlay() {
                ...
                $('#filterStatus, #filterParent').prop('disabled', true);
            ...
            function hideLoadingOverlay() {
                ...
                $('#filterStatus, #filterParent').prop('disabled', false);
                    ...
                    .DataTable({
                        ...
                        ajax: {
                            ...
                            error: function(xhr, error, thrown) {
                                ...
                                showAlert(
                                    '<strong>Error!</strong> Unable to load categories. Please check your connection and try again.',
                                    'danger',
                                    'error-warning-line',
                                    6000
                                );
                        ...
                        drawCallback: function(settings) {
                            ...
                            if ((isInitialLoad || isFilterChange) && recordsTotal > 0) {
                                showAlert(
                                    `<strong>Success!</strong> Loaded ${recordsTotal} category(ies) successfully.`,
                                    'success',
            ...
            function bindFilterEvents() {
                ...
                $resetBtn.on('click', function() {
                    ...
                    setTimeout(function() {
                        ...
                        showAlert(
                            '<strong>Filters Reset!</strong> Showing all categories.',
                            'info',
                            'information-line',
                            2500
                        );
            ...
            function initSubcategoryHandlers() {
                $(document).on('click', '.show-subcategories', function(e) {
                    e.preventDefault();
                    const $this = $(this);
                    ...
                    // Show notification
                    showAlert(
                        `<strong>Filter Applied!</strong> Now showing subcategories of "${categoryName}".`,
                        'info',
                        'folder-line',
                        3000
                    );
            ...
            $(document).ready(function() {
                ...
                setTimeout(function() {
                    if (isInitialLoad) {
                        showAlert(
                            '<strong>Welcome!</strong> Category management system loaded successfully.',
                            'info',
                            'information-line',
                            3000
                        );
